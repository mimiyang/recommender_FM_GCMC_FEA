...
for epoch in range(NB_EPOCH):
    ...
    saved_train_loss.append(train_rmse)
    saved_val_loss.append(val_rmse)
...
if TESTING:
    ...
    np.save(os.path.join('output', 'ml-1m_trloss.npy'), saved_train_loss)
    np.save(os.path.join('output', 'ml-1m_valloss.npy'), saved_val_loss)
